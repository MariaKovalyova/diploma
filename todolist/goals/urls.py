...
urlpatterns = [
    ...
    path('goal_category/<pk>', views.GoalCategoryView.as_view(), name='retrieve_goal_category'),
    ...
    path('goal_comment/<pk>', views.GoalCommentView.as_view(), name='retrieve_goal_comment'),
